      ...
      <div className="bg-gray-50 text-gray-800 min-h-screen flex flex-col font-sans">
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <a href="https://wa.me/6285727244126" target="_blank" rel="noopener noreferrer" className="bg-[#0070BA] text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-[#003087] transition-colors">
              Pesan via WA
            </a>
          </div>
        </header>
        ...
        <section className="py-20 px-6 bg-[#f0f4f8] text-center">
          <div className="container mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#003087]">Galeri</h1>
